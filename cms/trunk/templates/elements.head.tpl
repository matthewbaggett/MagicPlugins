...
<link rel="stylesheet" media="screen" href="{$page->site->sys_root}/plugins/cms/resources/css/famfamfam.css" />
<link rel="stylesheet" media="screen" href="{$page->site->sys_root}/plugins/cms/resources/css/google.css" />
